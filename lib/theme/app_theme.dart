...
/// A class that contains all theme configurations for the dental equipment distribution application.
class AppTheme {
  AppTheme._();

  // Corporate Precision Color Palette
  static const Color primaryLight = Color(0xFF0072BC); // Cobra Blue
  static const Color primaryVariantLight =
      Color(0xFF005A94); // Darker Cobra Blue
  static const Color secondaryLight = Color(0xFF006666); // Cobra Diamond
  static const Color secondaryVariantLight =
      Color(0xFF004D4D); // Darker Cobra Diamond
  static const Color accentLight = Color(0xFFFFCC00); // Cobra Yellow
  static const Color backgroundLight = Color(0xFFFFFFFF); // Pure white
  static const Color surfaceLight = Color(0xFFF9F9F9); // Light gray
  static const Color errorLight = Color(0xFFDC3545); // Standard red
  static const Color successLight = Color(0xFF00A86B); // Clean green
  static const Color warningLight = Color(0xFFFF8C00); // Orange
  ...
  static const Color primaryDark =
      Color(0xFF4A9FD9); // Lighter Cobra Blue for dark mode
  static const Color primaryVariantDark = Color(0xFF0072BC);
  static const Color secondaryDark = Color(0xFF4D9999); // Lighter Cobra Diamond
  static const Color secondaryVariantDark = Color(0xFF006666);
  static const Color accentDark =
      Color(0xFFFFCC00); // Cobra Yellow remains same
  ...
  static const Color textDisabledLight = Color(0xFFB0B0B0); // Light gray
  ...
  /// Light theme optimized for professional B2B dental equipment distribution
  ...
  /// Dark theme maintaining professional appearance for low-light environments
